...
geben anschliessend die ersten 6 Zeilen der neuen Tabelle (`head()`) aus:
...
Etwas trickreicher müssen wir vorgehen, wenn wir für den Gesamtumsatz (*total_revenue*), die Gesamtkosten (*total_cots*) und den Gesamtgewinn (*total_profit*) die Durchschnitte und deren Standardabweichungen in eine neue Tabelle speichern wollen: 
