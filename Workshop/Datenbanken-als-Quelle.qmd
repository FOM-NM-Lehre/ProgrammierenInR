...
Wir wollen mit einer [SQLite](https://sqlite.org) Datenbank beginnen.
...
Wir können direkt mit SQLite arbeiten oder aber via einer ODBC-API.
Für letzteres müssen wir ein paar Pakete in den Sopeicher laden:
