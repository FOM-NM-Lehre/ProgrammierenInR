...
Wir können u.a. das Sheet "tips" auswählen, wenn das Dokument mehrere Tabellen enhält:
...
Wir den nun den die selben Daten in der Tabelle:
...
3. Nutzen Sie die Hilfe um die Ausgabe der Größe der Rechnungsbeträge nach zu sortieren! (Tipp: Ist etwas schwerer! Suchen Sie mit der Hilfe im Paket [`dplyr`](https://dplyr.tidyverse.org/) nach dem Befehl [`arrange()`](https://dplyr.tidyverse.org/reference/arrange.html). ;-) ) 
