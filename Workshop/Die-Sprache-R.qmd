...
## Spalten und Zeilen auswählen mit `dem Paket `select()` und `filter()`
...
2. Gruppieren Sie nun die Ausgabe aus Aufgabe 1. so, dass sie nach Tagen ausgegeben wird (Tipp: `days`).
