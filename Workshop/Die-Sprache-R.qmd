...
Besser ist es daher mit dem Paket `dplyr`zu arbeiten. Spalten können wir mit dem Befehl `select()` auswählen:
...
Auch in einen Vektor umwandeln:
...
Zeilen mit dem Befehl `filter()` herausfiltern:
